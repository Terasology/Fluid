...
public interface FluidManager {
     ...
     * @param volume The volume of fluid being added
     */
    boolean addFluidFromHolder(EntityRef instigator, EntityRef inventory, EntityRef holder, int slot,
     ...
     */
    float moveFluid(EntityRef instigator, EntityRef from, EntityRef to, int slotFrom, String fluidType, int slotTo,
                    float volume);
}
