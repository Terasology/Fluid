...
public class FluidVolumeChangedInInventory implements Event {
     ...
     */
    private final float volumeBefore;

    /**
     * The volume of the fluid after the change
     */
    private final float volumeAfter;
     ...
     */
    public FluidVolumeChangedInInventory(EntityRef instigator, String fluidType, int slot, float volumeBefore,
                                         float volumeAfter) {
